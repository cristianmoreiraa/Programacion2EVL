...
public class Aplicacion {
    ...
    public static void main(String[] args) {
        ...
        int num;
        do{
            num = PedirDatos.pedirInt("1 --> Engadir libros\n2 --> Vender libros\n3 --> Amosar libros\n4 --> Dar de baixa os libros\n5 --> Consultar libro");
            switch(num){
                case 1:
                    obx.engadirLibros(aux);
                    break;
                case 2:
                    obx.venderLibro(aux, PedirDatos.pedirString("Teclee o titulo a vender"));
                    break;
                case 3:
                ...
                case 4:
                    ...
                    break;
                case 5:
                    obx.consultarLibro(aux,PedirDatos.pedirString("Teclee o titulo do libro a consultar"));
                    break;
                default:
